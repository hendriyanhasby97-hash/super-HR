...
window.loadPage = (page, element = null) => {
    ...
    switch (page) {
        case 'dashboard': pageTitle.innerText = "DASHBOARD STATISTIK SDM"; renderDashboard(container); break;
        case 'pegawai': pageTitle.innerText = "MASTER DATA PEGAWAI"; renderPegawai(container); break;
        case 'pegawai-masuk': pageTitle.innerText = "DATA PEGAWAI MASUK (BARU)"; renderPegawaiMasuk(container); break;
        case 'pegawai-keluar': pageTitle.innerText = "DATA PEGAWAI KELUAR / MUTASI"; renderPegawaiKeluar(container); break;
        case 'sik': pageTitle.innerText = "SURAT IZIN KERJA (SIK / SIP)"; renderSIK(container); break;
        case 'str': pageTitle.innerText = "SURAT TANDA REGISTRASI (STR)"; renderSTR(container); break;
    }
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function setupLayoutAkses() {
        ...
        if (currentRole === 'superadmin') {
            ...
            document.body.classList.add('view-only-mode'); // Mengaktifkan CSS penyembunyi tombol Edit/Tambah/Hapus
